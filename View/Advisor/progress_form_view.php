      ...
      require 'Layout/prog_form_content_view.php';
        ...
        if($message == "") {
          ...
          <div class='form-group prog-descr'>
            ...
            <textarea class='form-control' rows='5' name='comment' value='wut'></textarea>
            <button type='submit' name='submitType' value='save_comment' class='btn btn-primary submit-form-btn'>Post Comment</button>
          </div>
          ...
          if(!$form->approvedByAdvisor) { echo "
            ...
            <button type='submit' name='submitType' value='{$currAdvisor->uid}' class='btn btn-primary submit-form-btn'>Approve</button>"; 
          } else {
            echo "
