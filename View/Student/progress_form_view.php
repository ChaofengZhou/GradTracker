...
<link rel='stylesheet' href='../Assets/css/bootstrap-multiselect.css' type='text/css'/>
  ...
  if($message) {
    ...
    <div class='back-to-page'>
      <a href='..' class='btn btn-warning'><i class='fa fa-chevron-left' aria-hidden='true'></i> Back</a>
    </div>";
  }
      ...
      require 'Layout/prog_form_content_view.php';
        ...
        if($message == "") {
          if($_SESSION['role'] == 'student') {
            echo "</div><div class='p-form-btns1'>";
            if($form->submitted == 0) {
              echo "<a href='edit_progress_form.php?formId=$form->formId' class='btn btn-primary submit-form-btn'>Edit</a>";
            }
            echo "  
              <a href='mainpage.php' class='btn btn-danger submit-form-btn'> Back </a>
            </div>"; 
            ...
            if(!$form->approvedByAdvisor) { echo "
              <button type='submit' name='submitType' value='1' class='btn btn-primary submit-form-btn'>Approve</button>"; }
            else {
              echo "
              <button type='submit' name='submitType' value='0' class='btn btn-danger submit-form-btn'>Disapprove</button>";
            }
            echo"
